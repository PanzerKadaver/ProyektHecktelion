...
(function () {
	 ...
	 * @static
	 **/
	s.buildDate = /*=date*/"Fri, 08 May 2015 17:50:20 GMT"; // injected by build process
...
// constructor
	...
	function XHRRequest (item) {
		...
		/**
		 * A delay timeout that is used to voluntary slow the loading process
...
// constructor
	...
	function LoadQueue (preferXHR, basePath, crossOrigin) {
		...
		/**
		 * The delay beetween each file loading. Please see
		 * {{#crossLink "LoadQueue/setFileDelay"}}{{/crossLink}} for more information.
		 * @property _fileDelay
		 * @type {Number}
		 * @default 0
		 * @private
...
// public methods
	...
	/**
	 * Set a delay (in ms) beetween each file load.
	 * The delay will occur after "fileload" event and before
	 * the kick start of next file in the queue.
	 *
	 * <h4>Example</h4>
	 *
	 *      var queue = new createjs.LoadQueue();
	 *      queue.setFileDelay(100); // Separate each file load by a small delay. Usefull for loading animation (or debugging)
	 *
	 * @method setFileDelay
	 * @param {Number} value The length of a delay, in ms, beetween each file load.
	 * By default, there is no delay.
	 */
	p.setFileDelay = function (value) {
		this._fileDelay = value;
		if (this._fileDelay < 0)
			this._fileDelay = 0;
	}
...
// protected methods
	...
	p._processFinishedLoad = function (item, loader) {
		...
		this._delayTimeout = setTimeout(createjs.proxy(this._loadNext, this), this._fileDelay);
	};
